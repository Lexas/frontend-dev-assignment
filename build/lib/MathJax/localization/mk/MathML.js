...
,UnknownNodeType:"Непознат тип на јазол: %1",UnexpectedTextNode:"Неочекуван јазол во текстот: %1"
,ErrorParsingMathML:"Грешка при расчленувањето на MathML",ParsingError:"Грешка при расчленувањето на MathML: %1"
,MathMLSingleElement:"MathML мора да се образува од еден елемент",MathMLRootElement
:"MathML мора да се образува со елемент <math>, а не %1"}}),MathJax.Ajax.loadComplete
("[MathJax]/localization/mk/MathML.js");