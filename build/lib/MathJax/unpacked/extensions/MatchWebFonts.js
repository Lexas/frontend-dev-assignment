...
.defaultEx,l=this.defaultEm;if(f!==u.HTMLCSS.ex||l!==u.HTMLCSS.em){var c=f/this.TeX
.x_height/l;c=Math.floor(Math.max(this.config.minScaleAdjust/100,c)*this.config.scale
),c/100!==u.scale&&(r.push(script),n[i]={})}}n=n.concat(r);for(i=0,s=n.length;i<s
