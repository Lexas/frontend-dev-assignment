...
)),c-=20),v.skipUp=e.isContextMenu;else{var d="left",g=n.offsetWidth;l=v.isMobile?30
:g-2,c=0;while(n&&n!==i)l+=n.offsetLeft,c+=n.offsetTop,n=n.parentNode;!v.isMobile&&
(v.isRTL&&l-g-s.offsetWidth>this.margin||!v.isRTL&&l+s.offsetWidth>document.body.
offsetWidth-this.margin)&&(d="right",l=Math.max(this.margin,l-g-s.offsetWidth+6))
