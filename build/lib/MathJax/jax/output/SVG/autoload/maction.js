...
,this.cwidth=f.SVG.cwidth;var l=this.data[1];a=t.math(l);try{a.toSVG(u,o)}catch(h
){this.SetData(1,l),o.style.display="none";if(!h.restart)throw h;MathJax.Callback
.After(["SVGtooltipPost",this,e,n],h.restart);return}this.SetData(1,l),r=this},SVGtooltipClear
