...
.MathJax={},MathJax.version="2.5.1",MathJax.fileversion="2.5.1",MathJax.cdnVersion="2.5.1"
,MathJax.cdnFileVersions={},function(e){var t=window[e];t||(t=window[e]={});var n=
[],r=function(e){var t=e.constructor;t||(t=function(){});for(var n in e)n!=="constructor"&&
e.hasOwnProperty(n)&&(t[n]=e[n]);return t},i=function(){return function(){return arguments
.callee.Init.call(this,arguments)}};t.Object=r({constructor:i(),Subclass:function(
e,t){var r=i();return r.SUPER=this,r.Init=this.Init,r.Subclass=this.Subclass,r.Augment=
this.Augment,r.protoFunction=this.protoFunction,r.can=this.can,r.has=this.has,r.isa=
this.isa,r.prototype=new this(n),r.prototype.constructor=r,r.Augment(e,t),r},Init
:function(e){var t=this;return e.length===1&&e[0]===n?t:(t instanceof e.callee||(
t=new e.callee(n)),t.Init.apply(t,e)||t)},Augment:function(e,t){var n;if(e!=null)
{for(n in e)e.hasOwnProperty(n)&&this.protoFunction(n,e[n]);e.toString!==this.prototype
.toString&&e.toString!=={}.toString&&this.protoFunction("toString",e.toString)}if(
t!=null)for(n in t)t.hasOwnProperty(n)&&(this[n]=t[n]);return this},protoFunction
:function(e,t){this.prototype[e]=t,typeof t=="function"&&(t.SUPER=this.SUPER.prototype
)},prototype:{Init:function(){},SUPER:function(e){return e.callee.SUPER},can:function(
e){return typeof this[e]=="function"},has:function(e){return typeof this[e]!="undefined"
},isa:function(e){return e instanceof Object&&this instanceof e}},can:function(e)
{return this.prototype.can.call(this,e)},has:function(e){return this.prototype.has
.call(this,e)},isa:function(e){var t=this;while(t){if(t===e)return!0;t=t.SUPER}return!1
},SimpleSUPER:r({constructor:function(e){return this.SimpleSUPER.define(e)},define
:function(e){var t={};if(e!=null){for(var n in e)e.hasOwnProperty(n)&&(t[n]=this.
wrap(n,e[n]));e.toString!==this.prototype.toString&&e.toString!=={}.toString&&(t.
toString=this.wrap("toString",e.toString))}return t},wrap:function(e,t){if(typeof 
t!="function"||!t.toString().match(/\.\s*SUPER\s*\(/))return t;var n=function(){this
.SUPER=n.SUPER[e];try{var r=t.apply(this,arguments)}catch(i){throw delete this.SUPER
,i}return delete this.SUPER,r};return n.toString=function(){return t.toString.apply
(t,arguments)},n}})})}("MathJax"),function(BASENAME){var BASE=window[BASENAME];BASE||
(BASE=window[BASENAME]={});var CALLBACK=function(e){var t=function(){return arguments
.callee.execute.apply(arguments.callee,arguments)};for(var n in CALLBACK.prototype
)CALLBACK.prototype.hasOwnProperty(n)&&(typeof e[n]!="undefined"?t[n]=e[n]:t[n]=CALLBACK
.prototype[n]);return t.toString=CALLBACK.prototype.toString,t};CALLBACK.prototype=
{isCallback:!0,hook:function(){},data:[],object:window,execute:function(){if(!this
.called||this.autoReset)return this.called=!this.autoReset,this.hook.apply(this.object
,this.data.concat([].slice.call(arguments,0)))},reset:function(){delete this.called
},toString:function(){return this.hook.toString.apply(this.hook,arguments)}};var ISCALLBACK=
function(e){return typeof e=="function"&&e.isCallback},EVAL=function(code){return eval
.call(window,code)},TESTEVAL=function(){EVAL("var __TeSt_VaR__ = 1");if(window.__TeSt_VaR__
)try{delete window.__TeSt_VaR__}catch(e){window.__TeSt_VaR__=null}else window.execScript?
EVAL=function(e){BASE.__code=e,e="try {"+BASENAME+".__result = eval("+BASENAME+".__code)} catch(err) {"+
BASENAME+".__result = err}",window.execScript(e);var t=BASE.__result;delete BASE.
__result,delete BASE.__code;if(t instanceof Error)throw t;return t}:EVAL=function(
e){BASE.__code=e,e="try {"+BASENAME+".__result = eval("+BASENAME+".__code)} catch(err) {"+
BASENAME+".__result = err}";var t=document.getElementsByTagName("head")[0];t||(t=
document.body);var n=document.createElement("script");n.appendChild(document.createTextNode
(e)),t.appendChild(n),t.removeChild(n);var r=BASE.__result;delete BASE.__result,delete 
BASE.__code;if(r instanceof Error)throw r;return r};TESTEVAL=null},USING=function(
e,t){arguments.length>1&&(arguments.length===2&&typeof arguments[0]!="function"&&
arguments[0]instanceof Object&&typeof arguments[1]=="number"?e=[].slice.call(e,t)
:e=[].slice.call(arguments,0)),e instanceof Array&&e.length===1&&(e=e[0]);if(typeof 
e=="function")return e.execute===CALLBACK.prototype.execute?e:CALLBACK({hook:e});
if(e instanceof Array){if(typeof e[0]=="string"&&e[1]instanceof Object&&typeof e[1
][e[0]]=="function")return CALLBACK({hook:e[1][e[0]],object:e[1],data:e.slice(2)}
);if(typeof e[0]=="function")return CALLBACK({hook:e[0],data:e.slice(1)});if(typeof 
e[1]=="function")return CALLBACK({hook:e[1],object:e[0],data:e.slice(2)})}else{if(typeof 
e=="string")return TESTEVAL&&TESTEVAL(),CALLBACK({hook:EVAL,data:[e]});if(e instanceof 
Object)return CALLBACK(e);if(typeof e=="undefined")return CALLBACK({})}throw Error
("Can't make callback from given data")},DELAY=function(e,t){return t=USING(t),t.
timeout=setTimeout(t,e),t},WAITFOR=function(e,t){e=USING(e),e.called||(WAITSIGNAL
(e,t),t.pending++)},WAITEXECUTE=function(){var e=this.signal;delete this.signal,this
.execute=this.oldExecute,delete this.oldExecute;var t=this.execute.apply(this,arguments
);if(ISCALLBACK(t)&&!t.called)WAITSIGNAL(t,e);else for(var n=0,r=e.length;n<r;n++
)e[n].pending--,e[n].pending<=0&&e[n].call()},WAITSIGNAL=function(e,t){t instanceof 
Array||(t=[t]),e.signal?t.length===1?e.signal.push(t[0]):e.signal=e.signal.concat
(t):(e.oldExecute=e.execute,e.execute=WAITEXECUTE,e.signal=t)},AFTER=function(e){
e=USING(e),e.pending=0;for(var t=1,n=arguments.length;t<n;t++)arguments[t]&&WAITFOR
(arguments[t],e);if(e.pending===0){var r=e();ISCALLBACK(r)&&(e=r)}return e},HOOKS=
MathJax.Object.Subclass({Init:function(e){this.hooks=[],this.remove=[],this.reset=
e,this.running=!1},Add:function(e,t){t==null&&(t=10),ISCALLBACK(e)||(e=USING(e)),
e.priority=t;var n=this.hooks.length;while(n>0&&t<this.hooks[n-1].priority)n--;return this
.hooks.splice(n,0,e),e},Remove:function(e){for(var t=0,n=this.hooks.length;t<n;t++
)if(this.hooks[t]===e){this.running?this.remove.push(t):this.hooks.splice(t,1);return}
},Execute:function(){var e=[{}];this.running=!0;for(var t=0,n=this.hooks.length;t<
n;t++){this.reset&&this.hooks[t].reset();var r=this.hooks[t].apply(window,arguments
);ISCALLBACK(r)&&!r.called&&e.push(r)}return this.running=!1,this.remove.length&&
this.RemovePending(),e.length===1?null:e.length===2?e[1]:AFTER.apply({},e)},RemovePending
:function(){this.remove=this.remove.sort();for(var e=this.remove.length-1;e>=0;e--
)this.hooks.splice(e,1);this.remove=[]}}),EXECUTEHOOKS=function(e,t,n){if(!e)return null
;e instanceof Array||(e=[e]),t instanceof Array||(t=t==null?[]:[t]);var r=HOOKS(n
);for(var i=0,s=e.length;i<s;i++)r.Add(e[i]);return r.Execute.apply(r,t)},QUEUE=BASE
.Object.Subclass({Init:function(){this.pending=this.running=0,this.queue=[],this.
Push.apply(this,arguments)},Push:function(){var e;for(var t=0,n=arguments.length;
t<n;t++)e=USING(arguments[t]),e===arguments[t]&&!e.called&&(e=USING(["wait",this,
e])),this.queue.push(e);return!this.running&&!this.pending&&this.Process(),e},Process
:function(e){while(!this.running&&!this.pending&&this.queue.length){var t=this.queue
[0];e=this.queue.slice(1),this.queue=[],this.Suspend();var n=t();this.Resume(),e.
length&&(this.queue=e.concat(this.queue)),ISCALLBACK(n)&&!n.called&&WAITFOR(n,this
)}},Suspend:function(){this.running++},Resume:function(){this.running&&this.running--
},call:function(){this.Process.apply(this,arguments)},wait:function(e){return e}}
),SIGNAL=QUEUE.Subclass({Init:function(e){QUEUE.prototype.Init.call(this),this.name=
e,this.posted=[],this.listeners=HOOKS(!0),this.posting=!1,this.callback=null},Post
:function(e,t,n){t=USING(t);if(this.posting||this.pending)this.Push(["Post",this,
e,t,n]);else{this.callback=t,t.reset(),n||this.posted.push(e),this.Suspend(),this
.posting=!0;var r=this.listeners.Execute(e);ISCALLBACK(r)&&!r.called&&WAITFOR(r,this
),this.Resume(),this.posting=!1,this.pending||this.call()}return t},Clear:function(
e){return e=USING(e),this.posting||this.pending?e=this.Push(["Clear",this,e]):(this
.posted=[],e()),e},call:function(){this.callback(this),this.Process()},Interest:function(
e,t,n){e=USING(e),this.listeners.Add(e,n);if(!t)for(var r=0,i=this.posted.length;
r<i;r++){e.reset();var s=e(this.posted[r]);ISCALLBACK(s)&&r===this.posted.length-1&&
WAITFOR(s,this)}return e},NoInterest:function(e){this.listeners.Remove(e)},MessageHook
:function(e,t,n){t=USING(t),this.hooks||(this.hooks={},this.Interest(["ExecuteHooks"
,this])),this.hooks[e]||(this.hooks[e]=HOOKS(!0)),this.hooks[e].Add(t,n);for(var r=0
,i=this.posted.length;r<i;r++)this.posted[r]==e&&(t.reset(),t(this.posted[r]));return t
.msg=e,t},ExecuteHooks:function(e){var t=e instanceof Array?e[0]:e;return this.hooks
[t]?this.hooks[t].Execute(e):null},RemoveHook:function(e){this.hooks[e.msg].Remove
(e)}},{signals:{},find:function(e){return SIGNAL.signals[e]||(SIGNAL.signals[e]=new 
SIGNAL(e)),SIGNAL.signals[e]}});BASE.Callback=BASE.CallBack=USING,BASE.Callback.Delay=
DELAY,BASE.Callback.After=AFTER,BASE.Callback.Queue=QUEUE,BASE.Callback.Signal=SIGNAL
.find,BASE.Callback.Hooks=HOOKS,BASE.Callback.ExecuteHooks=EXECUTEHOOKS}("MathJax"
),function(e){var t=window[e];t||(t=window[e]={});var n=navigator.vendor==="Apple Computer, Inc."&&typeof 
navigator.vendorSub=="undefined",r=0,i=function(e){return document.styleSheets&&document
.styleSheets.length>r&&(r=document.styleSheets.length),e||(e=document.head||document
.getElementsByTagName("head")[0],e||(e=document.body)),e},s=[],o=function(){for(var e=0
,n=s.length;e<n;e++)t.Ajax.head.removeChild(s[e]);s=[]},u={};u[e]="",t.Ajax={loaded
:{},loading:{},loadHooks:{},timeout:15e3,styleDelay:1,config:{root:"",path:u},STATUS
:{OK:1,ERROR:-1},fileURL:function(e){var t=e.match(/^\[([-._a-z0-9]+)\]/i);return t&&
t[1]in u&&(e=(u[t[1]]||this.config.root)+e.substr(t[1].length+2)),e},fileName:function(
t){var n=this.config.root;if(t.substr(0,n.length)===n)t="["+e+"]"+t.substr(n.length
);else for(var r in u)if(u.hasOwnProperty(r)&&u[r]&&t.substr(0,u[r].length)===u[r
]){t="["+r+"]"+t.substr(u[r].length);break}return t},fileRev:function(e){var n=t.
cdnFileVersions[name]||t.cdnVersion;return n&&(n="?rev="+n),n},urlRev:function(e)
{return this.fileURL(e)+this.fileRev(e)},Require:function(e,n){n=t.Callback(n);var r
;if(e instanceof Object)for(var i in e)e.hasOwnProperty(i)&&(r=i.toUpperCase(),e=
e[i]);else r=e.split(/\./).pop().toUpperCase();e=this.fileURL(e);if(this.loaded[e
])n(this.loaded[e]);else{var s={};s[r]=e,this.Load(s,n)}return n},Load:function(e
,n){n=t.Callback(n);var r;if(e instanceof Object)for(var s in e)e.hasOwnProperty(
s)&&(r=s.toUpperCase(),e=e[s]);else r=e.split(/\./).pop().toUpperCase();e=this.fileURL
(e);if(this.loading[e])this.addHook(e,n);else{this.head=i(this.head);if(!this.loader
[r])throw Error("Can't load files of type "+r);this.loader[r].call(this,e,n)}return n
},LoadHook:function(e,n,r){n=t.Callback(n);if(e instanceof Object)for(var i in e)
e.hasOwnProperty(i)&&(e=e[i]);return e=this.fileURL(e),this.loaded[e]?n(this.loaded
[e]):this.addHook(e,n,r),n},addHook:function(e,t,n){this.loadHooks[e]||(this.loadHooks
[e]=MathJax.Callback.Hooks()),this.loadHooks[e].Add(t,n),t.file=e},removeHook:function(
e){this.loadHooks[e.file]&&(this.loadHooks[e.file].Remove(e),this.loadHooks[e.file
].hooks.length||delete this.loadHooks[e.file])},Preloading:function(){for(var e=0
,t=arguments.length;e<t;e++){var n=this.fileURL(arguments[e]);this.loading[n]||(this
.loading[n]={preloaded:!0})}},loader:{JS:function(e,n){var r=this.fileName(e),i=document
.createElement("script"),s=t.Callback(["loadTimeout",this,e]);this.loading[e]={callback
:n,timeout:setTimeout(s,this.timeout),status:this.STATUS.OK,script:i},this.loading
[e].message=t.Message.File(r),i.onerror=s,i.type="text/javascript",i.src=e+this.fileRev
(r),this.head.appendChild(i)},CSS:function(e,n){var r=this.fileName(e),i=document
.createElement("link");i.rel="stylesheet",i.type="text/css",i.href=e+this.fileRev
(r),this.loading[e]={callback:n,message:t.Message.File(r),status:this.STATUS.OK},
this.head.appendChild(i),this.timer.create.call(this,[this.timer.file,e],i)}},timer
:{create:function(e,i){return e=t.Callback(e),i.nodeName==="STYLE"&&i.styleSheet&&typeof 
i.styleSheet.cssText!="undefined"?e(this.STATUS.OK):window.chrome&&i.nodeName==="LINK"?
e(this.STATUS.OK):n?this.timer.start(this,[this.timer.checkSafari2,r++,e],this.styleDelay
):this.timer.start(this,[this.timer.checkLength,i,e],this.styleDelay),e},start:function(
e,n,r,i){n=t.Callback(n),n.execute=this.execute,n.time=this.time,n.STATUS=e.STATUS
,n.timeout=i||e.timeout,n.delay=n.total=r||0,r?setTimeout(n,r):n()},time:function(
e){return this.total+=this.delay,this.delay=Math.floor(this.delay*1.05+5),this.total>=
this.timeout?(e(this.STATUS.ERROR),1):0},file:function(e,n){n<0?t.Ajax.loadTimeout
(e):t.Ajax.loadComplete(e)},execute:function(){this.hook.call(this.object,this,this
.data[0],this.data[1])},checkSafari2:function(e,t,n){if(e.time(n))return;document
.styleSheets.length>t&&document.styleSheets[t].cssRules&&document.styleSheets[t].
cssRules.length?n(e.STATUS.OK):setTimeout(e,e.delay)},checkLength:function(e,n,r)
{if(e.time(r))return;var i=0,s=n.sheet||n.styleSheet;try{(s.cssRules||s.rules||[]
).length>0&&(i=1)}catch(o){o.message.match(/protected variable|restricted URI/)?i=1
:o.message.match(/Security error/)&&(i=1)}i?setTimeout(t.Callback([r,e.STATUS.OK]
),0):setTimeout(e,e.delay)}},loadComplete:function(e){e=this.fileURL(e);var n=this
.loading[e];return n&&!n.preloaded?(t.Message.Clear(n.message),clearTimeout(n.timeout
),n.script&&(s.length===0&&setTimeout(o,0),s.push(n.script)),this.loaded[e]=n.status
,delete this.loading[e],this.addHook(e,n.callback)):(n&&delete this.loading[e],this
.loaded[e]=this.STATUS.OK,n={status:this.STATUS.OK}),this.loadHooks[e]?this.loadHooks
[e].Execute(n.status):null},loadTimeout:function(e){this.loading[e].timeout&&clearTimeout
(this.loading[e].timeout),this.loading[e].status=this.STATUS.ERROR,this.loadError
(e),this.loadComplete(e)},loadError:function(e){t.Message.Set(["LoadFailed","File failed to load: %1"
,e],null,2e3),t.Hub.signal.Post(["file load error",e])},Styles:function(e,n){var r=
this.StyleString(e);if(r==="")n=t.Callback(n),n();else{var s=document.createElement
("style");s.type="text/css",this.head=i(this.head),this.head.appendChild(s),s.styleSheet&&typeof 
s.styleSheet.cssText!="undefined"?s.styleSheet.cssText=r:s.appendChild(document.createTextNode
(r)),n=this.timer.create.call(this,n,s)}return n},StyleString:function(e){if(typeof 
e=="string")return e;var t="",n,r;for(n in e)if(e.hasOwnProperty(n))if(typeof e[n
]=="string")t+=n+" {"+e[n]+"}\n";else if(e[n]instanceof Array)for(var i=0;i<e[n].
length;i++)r={},r[n]=e[n][i],t+=this.StyleString(r);else if(n.substr(0,6)==="@media"
)t+=n+" {"+this.StyleString(e[n])+"}\n";else if(e[n]!=null){r=[];for(var s in e[n
])e[n].hasOwnProperty(s)&&e[n][s]!=null&&(r[r.length]=s+": "+e[n][s]);t+=n+" {"+r
.join("; ")+"}\n"}return t}}}("MathJax"),MathJax.HTML={Element:function(e,t,n){var r=
document.createElement(e);if(t){if(t.style){var i=t.style;t.style={};for(var s in 
i)i.hasOwnProperty(s)&&(t.style[s.replace(/-([a-z])/g,this.ucMatch)]=i[s])}MathJax
.Hub.Insert(r,t)}if(n){n instanceof Array||(n=[n]);for(var o=0;o<n.length;o++)n[o
]instanceof Array?r.appendChild(this.Element(n[o][0],n[o][1],n[o][2])):e==="script"?
this.setScript(r,n[o]):r.appendChild(document.createTextNode(n[o]))}return r},ucMatch
:function(e,t){return t.toUpperCase()},addElement:function(e,t,n,r){return e.appendChild
(this.Element(t,n,r))},TextNode:function(e){return document.createTextNode(e)},addText
:function(e,t){return e.appendChild(this.TextNode(t))},setScript:function(e,t){if(
this.setScriptBug)e.text=t;else{while(e.firstChild)e.removeChild(e.firstChild);this
.addText(e,t)}},getScript:function(e){var t=e.text===""?e.innerHTML:e.text;return t
.replace(/^\s+/,"").replace(/\s+$/,"")},Cookie:{prefix:"mjx",expires:365,Set:function(
e,t){var n=[];if(t)for(var r in t)t.hasOwnProperty(r)&&n.push(r+":"+t[r].toString
().replace(/&/g,"&&"));var i=this.prefix+"."+e+"="+escape(n.join("&;"));if(this.expires
){var s=new Date;s.setDate(s.getDate()+this.expires),i+="; expires="+s.toGMTString
()}try{document.cookie=i+"; path=/"}catch(o){}},Get:function(e,t){t||(t={});var n=new 
RegExp("(?:^|;\\s*)"+this.prefix+"\\."+e+"=([^;]*)(?:;|$)"),r;try{r=n.exec(document
.cookie)}catch(i){}if(r&&r[1]!==""){var s=unescape(r[1]).split("&;");for(var o=0,
u=s.length;o<u;o++){r=s[o].match(/([^:]+):(.*)/);var a=r[2].replace(/&&/g,"&");a==="true"?
a=!0:a==="false"?a=!1:a.match(/^-?(\d+(\.\d+)?|\.\d+)$/)&&(a=parseFloat(a)),t[r[1
]]=a}}return t}}},MathJax.Localization={locale:"en",directory:"[MathJax]/localization"
,strings:{ast:{menuTitle:"asturianu"},bcc:{menuTitle:"بلوچی"},br:{menuTitle:"brezhoneg"
},ca:{menuTitle:"català"},cdo:{menuTitle:"Mìng-dĕ̤ng-ngṳ̄"},cs:{menuTitle:"čeština"
},da:{menuTitle:"dansk"},de:{menuTitle:"Deutsch"},en:{menuTitle:"English",isLoaded
:!0},eo:{menuTitle:"Esperanto"},es:{menuTitle:"español"},fa:{menuTitle:"فارسی"},fi
:{menuTitle:"suomi"},fr:{menuTitle:"français"},gl:{menuTitle:"galego"},he:{menuTitle
:"עברית"},ia:{menuTitle:"interlingua"},it:{menuTitle:"italiano"},ja:{menuTitle:"日本語"
},kn:{menuTitle:"ಕನ್ನಡ"},ko:{menuTitle:"한국어"},lb:{menuTitle:"Lëtzebuergesch"},mk:
{menuTitle:"македонски"},nl:{menuTitle:"Nederlands"},oc:{menuTitle:"occitan"},pl:
{menuTitle:"polski"},pt:{menuTitle:"portugusê"},"pt-br":{menuTitle:"português do Brasil"
...
],copyTranslate:!0,Process:function(e,n){var o=s.Queue(),u,a=this.elementJax;a instanceof 
Array||(a=[a]);for(var f=0,l=a.length;f<l;f++)u=t.ElementJax.directory+"/"+a[f]+"/"+
...
this.JAXFILE;var c=o.Push(i.Require(u));return c.called||(this.constructor.prototype
.Process=function(){if(!c.called)return c;throw Error(u+" failed to load properly"
)}),a=r.outputJax["jax/"+a[0]],a&&o.Push(i.Require(a[0].directory+"/"+this.JAXFILE
