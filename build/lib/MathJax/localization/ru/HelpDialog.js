...
MathJax.Localization.addTranslation("ru","HelpDialog",{version:"2.5.0",isLoaded:!0
,strings:{Help:"Помочь по MathJax",MathJax:"*MathJax* — библиотека на JavaScript, позволяющая выводить формулы на веб-страницах. Их читателям для этого ничего не надо делать."
...
,Language:"*Язык* позволяет выбрать язык меню и сообщений MathJax.",Zoom:"*Увеличение* позволяет увеличить формулу."
