...
(d.hover.remove),delete d.hover.remove),d.hover.nofade=!0);var m=MathJax.Menu,g,y
;if(m){if(m.loadingDomain)return h.False(t);g=i.loadDomain("MathMenu");if(!g){m.jax=
d;var b=m.menu.Find("Show Math As").menu;b.items[0].name=d.sourceMenuTitle,b.items
[0].format=d.sourceMenuFormat||"MathML",b.items[1].name=o[d.inputJax].sourceMenuTitle
,b.items[5].disabled=!o[d.inputJax].annotationEncoding;var w=b.items[2];w.disabled=!0
;var E=w.menu.items;annotationList=MathJax.Hub.Config.semanticsAnnotations;for(var S=0
,x=E.length;S<x;S++){var T=E[S].name[1];d.root&&d.root.getAnnotation(T)!==null?(w
.disabled=!1,E[S].hidden=!1):E[S].hidden=!0}var N=m.menu.Find("Math Settings","MathPlayer"
);return N.hidden=d.outputJax!=="NativeMML"||!e.Browser.hasMathPlayer,m.menu.Post
(t)}m.loadingDomain=!0,y=function(){delete m.loadingDomain}}else{if(n.loadingMathMenu
)return h.False(t);n.loadingMathMenu=!0,g=n.Require("[MathJax]/extensions/MathMenu.js"
),y=function(){delete n.loadingMathMenu,MathJax.Menu||(MathJax.Menu={})}}var C={pageX
:t.pageX,pageY:t.pageY,clientX:t.clientX,clientY:t.clientY};return r.Queue(g,y,["ContextMenu"
,h,C,u,a]),h.False(t)},AltContextMenu:function(t,n){var r=s[n.jaxID],i=(r.config.
