...
MathJax.Localization.addTranslation("fa","FontWarnings",{version:"2.5.0",isLoaded
:!0,strings:{webFont:"MathJax از قلم‌های وبی برای نمایش ریاضیات در این صفحه استفاده می‌کند. این ممکن است زمانی جهت بارگیری بگیرد بنابراین اگر شما قلم‌های ریاضی را به‌صورت مستقیم در پوشهٔ قلم‌های سیستم‌عامل خود قرار دهید نمایش صفحات سریعتر خواهند شد."
