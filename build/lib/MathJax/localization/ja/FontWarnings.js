...
MathJax.Localization.addTranslation("ja","FontWarnings",{version:"2.5.0",isLoaded
:!0,strings:{webFont:"MathJax はこのページで、数式を表示するためにウェブ ベースのフォントを使用しています。フォントのダウンロードに時間がかかるため、あなたのシステムのフォント フォルダーに数式フォントを直接インストールすることでページのレンダリングがより速くなります。"
