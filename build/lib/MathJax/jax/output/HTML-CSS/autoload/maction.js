...
;var a=u.insertBefore(n.EmExSpan.cloneNode(!0),u.firstChild),l=a.firstChild.offsetHeight/60
,h=a.lastChild.firstChild.offsetHeight/60;n.em=n.outerEm=t.mbase.prototype.em=h;var p=
Math.floor(Math.max(n.config.minScaleAdjust/100,l/n.TeX.x_height/h)*n.config.scale
);u.firstChild.style.fontSize=p+"%",a.parentNode.removeChild(a);var v=n.createStack
(u.firstChild.firstChild),m=n.createBox(v);try{n.Measured(this.data[1].toHTML(m),
m)}catch(g){if(!g.restart)throw g;u.style.display="none",MathJax.Callback.After(["HTMLtooltipPost"
,this,e,o],g.restart);return}n.placeBox(m,0,0),n.createRule(u.firstChild.firstChild
,m.bbox.h,m.bbox.d,0),r=this},HTMLtooltipClear:function(e){var t=this.HTMLtooltip
