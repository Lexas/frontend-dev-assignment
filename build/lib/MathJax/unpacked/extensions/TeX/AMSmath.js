...
.autoTag();if(u.tag){var a=[this.getTag(),e.mtd(o)],f={side:t.config.TagSide,minlabelspacing
:t.config.TagIndent,columnalign:o.displayAlign,displaystyle:"inherit"};o.displayAlign===
e.INDENTALIGN.LEFT?(f.width="100%",o.displayIndent!=="0"&&(f.columnwidth=o.displayIndent+" fit"
,f.columnspacing="0",a=[a[0],e.mtd(),a[1]])):o.displayAlign===e.INDENTALIGN.RIGHT&&
(f.width="100%",o.displayIndent!=="0"&&(f.columnwidth="fit "+o.displayIndent,f.columnspacing="0"
,a[2]=e.mtd())),o=e.mtable(e.mlabeledtr.apply(e,a)).With(f)}return i.mml(o)}return this
